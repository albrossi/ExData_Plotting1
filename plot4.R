    ...
    plot(datetime, dados$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex=0.2)
    plot(datetime, dados$Voltage, type="l", xlab="datetime", ylab="Voltage")
    ...
    plot(datetime, dados$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power", cex=0.2)
